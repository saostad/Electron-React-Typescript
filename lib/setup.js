...
(async () => {
  try {
    ...
    const res = await fetch(
      `https://clients2.google.com/service/update2/crx?response=redirect&prodversion=89.0&x=id%3D${reactDevToolsExtensionId}%26installsource%3Dondemand%26uc`,
    );
    ...
    await runShellCmd(`npm un unzipper node-fetch"`);
